      ...
      <div>
        ...
        <Switch>
          <Route
            ...
            path="/updateProfile"
            component={() => (
              <UserProfile store={this.returnUserProfileStore()} />
            )}
          />
          <Route
            exact
            path="/login"
            component={() => (
              <LoginComponent store={this.returnLoginLogoutStore()} />
            )}
          />
          ...
          <Route
            exact
            path="/signup"
            component={() => <SignUp store={this.returnSignupStore()} />}
          />
          <Route
            path="/"
            component={() => (
              <MiddleComponent store={this.returnMiddleStore()} />
            )}
          />
        </Switch>
