...
import { isObjectNotNull } from "../extraFunctionalities/extraFunctionalities";
...
class Header extends Component {
  ...
  getDisplayName = () => {
    ...
    if (isObjectNotNull(this.props.store.auth.user)) {
      if (isObjectNotNull(this.props.store.auth.user.displayName)) {
        DisplayName = this.props.store.auth.user.displayName;
      } else if (isObjectNotNull(this.props.store.userProfile.userProfile)) {
        if (
          isObjectNotNull(this.props.store.userProfile.userProfile.displayName)
        ) {
  ...
  render() {
    return (
      <React.Fragment>
                  ...
                  {!this.props.store.auth.isAuthenticated ? (
                    ...
                    <div>
                      ...
                      <Button outline onClick={this.handleUpdateProfile}>
                        <span className="fa fa-sign-out fa-lg"></span> Update
                        Profile
                      </Button>
        ...
        <Modal
          isOpen={this.state.isLoginModelOpen}
        ...
        >
          ...
          <ModalBody>
            ...
            <p></p>
            <p>
              <a href="javascript:" onClick={this.handleCreateNewAccount}>
                {" "}
        ...
        <Modal
          isOpen={this.state.isSignupModelOpen}
        ...
        >
          ...
          <ModalBody>
            ...
            <Button color="danger" onClick={this.handleGoogleSignup}>
